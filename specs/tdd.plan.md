...
| Test Case ID | FR | Description | Test File |
|--------------|----|----|------------|
| TC-001-01 | FR-001 | Setting data property stores deep clone | core-data.test.ts |
| TC-001-02 | FR-001 | Getting data returns clean array without markers | core-data.test.ts |
| TC-001-03 | FR-001 | Setting data dispatches datachanged event | core-data.test.ts |
| TC-001-04 | FR-001 | Non-array data results in empty array | core-data.test.ts |
...
| Test Case ID | NFR | Description | Test File |
|--------------|-----|-------------|------------|
...
| TC-R-001-01 | NFR-R-001 | External mutation doesn't affect state | core-data.test.ts |
| TC-R-002-01 | NFR-R-002 | Circular references handled | core-data.test.ts |
| TC-R-003-01 | NFR-R-003 | Non-array data handled gracefully | core-data.test.ts |
...
1. RED: Write TC-001-01 (data setter stores deep clone)
2. GREEN: Implement data setter with JSON clone
3. REFACTOR: Extract deepClone utility
4. RED: Write TC-001-02 (data getter returns clean array)
5. GREEN: Implement getter that strips markers
